...
## O objetivo do curso é apresentar ao alunos os métodos e os estudo teóricos no campo das ciências sociais computacionais (CSS). E dinimuir o gap entre ciências social e ciência computacional.
...
#### Parte II: Ciências Sociais Computacionais Aplicadas (Semana 8-14).
  ...
  - Axperimentos, experimentos digitais 
