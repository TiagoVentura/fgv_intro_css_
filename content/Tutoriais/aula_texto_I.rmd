...
Algumas vezes, vocês encontrarão arquivos de texto salvos como `.csvs` Abri-los é tão simples como acessar qualquer outro tipo de arquivo csv. Abriremos um exemplo com discursos do plenário de deputados no Brasil e com este banco de dados vamos seguir no restante das aulas. 
...
Aprendemos há algumas aulas atrás o conceito de banco de dados tidy.  As três propriedades mais importantes que definem um banco de dados `tidy` são:
...
#### Um banco de dados de texto **Tidy** é organizado como um **token** por linha. 
