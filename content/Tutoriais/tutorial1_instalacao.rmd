...
Existem vários pacotes que são fornecidos com a distribuição R. Eles são conhecidos como [pacotes básicos](https://stat.ethz.ch/R-manual/R-devel/library/base/html/00Index.html). Porém, há pacotes criados por desenvolvedores que precisamos instalar e ativar no R. 
