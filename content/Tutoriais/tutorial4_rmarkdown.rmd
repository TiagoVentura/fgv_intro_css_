...
1. Uso de R Markdown para gerar relatórios dinâmicos, integram texto e resultados de R. (Hoje). 
...
Aumentar a transparências é fundamental para produzirmos ciência de qualidade. Por isto, o R Markdown é uma ferramenta bastante utilizada hoje em dia. 
...
Os "chunks" começam com um cabeçalho que consiste em $```{r}$ e o final do bloco é indicado por um $ ```$. Tudo entre estes dois sinais são lidos como um script de R. 
Você executar o código dentro de cada chunck usando o atalho de teclado que aprendemos anteriormente: `Cmd / Ctrl + Enter`. 
